...
describe('WorkflowMetrics', () => {
  ...
  it('replays only when the metric grid reaches the visible center band', () => {
    ...
    expect(componentSource).toContain('setEntered(entry.isIntersecting)')
    expect(componentSource).toContain("rootMargin: '0px 0px -45% 0px'")
    expect(componentSource).toContain('threshold: 0.15')
